/**
 * Modal dialog component for displaying notifications and confirmations
 * Provides a reusable modal system with customizable content and actions
 */
export class Modal {
    /**
     * Creates a new modal instance
     * Sets up DOM elements but doesn't attach to document until shown
     */
    constructor() {
        ...
        // Create icon container for modal icon
        ...
        this.modalElement.appendChild(this.iconContainer);
    ...
    /**
     * Shows the modal with custom options
     * 
     * @param {Object} options - Configuration options for the modal
     * @param {string} [options.title='Confirm'] - Modal title text
     * @param {string} [options.message='Are you sure?'] - Modal message text
     * @param {string} [options.type] - Modal type for styling (e.g., 'warning', 'reset')
     * @param {string} [options.icon] - HTML for the icon to display
     ...
     * @param {boolean} [options.hideConfirm=false] - Whether to hide confirm button
     * @param {boolean} [options.hideCancel=false] - Whether to hide cancel button
     */
    show(options) {
        // Set content
        ...
        // Adjust footer alignment based on visible buttons
    ...
    /**
     * Shows a warning modal with predefined styling
     * 
     * @param {string} message - Warning message to display
     * @param {string} [title='Warning'] - Title for the warning modal
     */
    ...
    /**
     * Shows a reset confirmation modal with predefined styling
     * 
     * @param {string} message - Reset confirmation message
     * @param {Function} onReset - Callback function when reset is confirmed
     * @param {string} [title='Reset'] - Title for the reset modal
     */
